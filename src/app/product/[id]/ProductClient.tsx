...
// 🎯 IMPORT Types จาก service layer (type-only: ไม่ดึง Prisma มาฝั่ง client)
import type {
  UIProduct,
  CardPartsVisibility,
} from "@/app/api/mock/products/_store";

// Type สำหรับ Discount Rules (ใช้กับ frame / badge รอบรูปสินค้า)
...
export default function ProductClient({
  product,
  // ใช้ค่า default เป็น object เปล่า แต่ cast เป็น CardPartsVisibility
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 lg:gap-12 mb-12">
          ...
          <div className="lg:col-span-3 space-y-4 lg:space-y-6">
            ...
            <ServiceFeatures
              ...
              freeShipMinimum={product.freeShipMinimum}
