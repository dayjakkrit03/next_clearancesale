...
//   // ถ้าอยู่ใน mock mode → ไม่ต้องไปยุ่งกับ navisions table เลย
//   if (NAVISION_MOCK) {
//     return {};
//   }
...
//  *
//  * + ถ้า NAVISION_MOCK=1 → ไม่ยิง Navision จริง ใช้ค่าใน DB จำลองแทน
//  */
...
//   /* ---------- MOCK MODE: ไม่ยิง Navision จริง ---------- */
//   if (NAVISION_MOCK) {
//     // ลองใช้ clearanceQuantity ใน products_clearance เป็น "stock" mock
//     await setInterlinkSessionTZ();
//     const productRow = await prismaInterlink.products_clearance.findFirst({
//       where: { product_sku: product },
//       select: { clearanceQuantity: true },
//     });

//     // ถ้าไม่มีค่า ให้ default เป็น 99999 (ถือว่ามีของเยอะ ๆ ไว้ dev)
//     let rawStock = Number(
//       productRow?.clearanceQuantity != null
//         ? productRow.clearanceQuantity
//         : 99999,
//     );
...
//     // เคลียร์ lock ที่หมดเวลา + หัก lock ตาม logic เดิม
...
//     // เก็บ rawStock (mock) ลง clearanceQuantity ด้วย เหมือน branch จริง
//     try {
//       await prismaInterlink.products_clearance.updateMany({
//         where: { product_sku: product },
//         data: { clearanceQuantity: rawStock },
//       });
//     } catch (e) {
//       console.error(
//         "[cart.service] MOCK: Failed to update products_clearance.clearanceQuantity",
//         e,
//       );
//     }
...
//     // ถ้าเรียก Navision ไม่ได้ → ถือว่าไม่มีของ (กันไม่ให้ /api/cart/add ตาย 500)
//     return 0;
//   }
...
//   // ✅ เก็บ "จำนวนคงเหลือตาม Navision" ตรง ๆ ลง clearanceQuantity
//   try {
//     await setInterlinkSessionTZ();
//     await prismaInterlink.products_clearance.updateMany({
//       where: { product_sku: product },
//       data: {
//         clearanceQuantity: rawStock,
//       },
//     });
//   } catch (e) {
//     console.error(
